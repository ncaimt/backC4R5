...
public class UsuarioRepository {
    ...
    public Optional <Usuario> lastUserId(){
        return  crudUsuarioRepository.findTopByOrderByIdDesc();
    }
    
    public List<Usuario> findByMonthBirthtDay(String birthday) {
        return crudUsuarioRepository.findByMonthBirthtDay(birthday);
    }
